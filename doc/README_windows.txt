...
Intro
-----
EcoPay (ECP) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. EcoPay utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run ecopay-qt.exe.

EcoPay Core is the original EcoPay client and it builds the backbone of the network.
However, it downloads and stores the entire history of EcoPay transactions;
