...
This mechanism has been integrated into Bitcore-Node-EcoPay which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ecopay/insight-api-ecopay#web-socket-api](https://github.com/ecopay/insight-api-ecopay#web-socket-api)
* API: [https://github.com/ecopay/insight-api-ecopay#swifttx-transactions](https://github.com/ecopay/insight-api-ecopay#swifttx-transactions)
...
By default, the EcoPay Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the EcoPay Core daemon:
