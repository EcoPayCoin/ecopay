...
In order to support loading of multiple wallets in ecopay-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ecopay.cpp.
...
Changes to ecopay.cpp
----------------------
ecopay.cpp is the entry point into ecopay-qt, and as such, will require some minor modifications to provide hooks for
