...
#   c) node1 mines 32 blocks, so now node 0 has 500000ECP, node 1 has 4250ECP, node2 has none.
#   d) node0 sends 601 ECP to node2, in two transactions (301 ECP, then 300 ECP).
