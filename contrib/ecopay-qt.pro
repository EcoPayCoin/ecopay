...
RESOURCES += src/qt/ecopay.qrc src/qt/ecopay_locale.qrc

TRANSLATIONS += src/qt/locale/ecopay_bg.ts \
                src/qt/locale/ecopay_de.ts \
                src/qt/locale/ecopay_en.ts \
                src/qt/locale/ecopay_es.ts \
                src/qt/locale/ecopay_fi.ts \
                src/qt/locale/ecopay_fr.ts \
                src/qt/locale/ecopay_it.ts \
                src/qt/locale/ecopay_ja.ts \
                src/qt/locale/ecopay_pl.ts \
                src/qt/locale/ecopay_pt.ts \
                src/qt/locale/ecopay_ru.ts \
                src/qt/locale/ecopay_sk.ts \
                src/qt/locale/ecopay_sv.ts \
                src/qt/locale/ecopay_vi.ts \
                src/qt/locale/ecopay_zh_CN.ts \
                src/qt/locale/ecopay_zh_TW.ts
