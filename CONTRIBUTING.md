Contributing to EcoPay Core
==================================

The EcoPay Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EcoPay Core project, and is not to be
confused with overall EcoPay Network Protocol consensus changes.

Whether a pull request is merged into EcoPay Core rests with the project merge
...
Patches that change EcoPay consensus rules are considerably more involved than
...
Where a patch set proposes to change the EcoPay consensus, it must have been
...
The project leader is the release manager for each EcoPay Core release.
