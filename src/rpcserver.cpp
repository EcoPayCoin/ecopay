...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EcoPay features */
        {"ecopay", "masternode", &masternode, true, true, false},
        {"ecopay", "listmasternodes", &listmasternodes, true, true, false},
        {"ecopay", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ecopay", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ecopay", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ecopay", "masternodedebug", &masternodedebug, true, true, false},
        {"ecopay", "startmasternode", &startmasternode, true, true, false},
        {"ecopay", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ecopay", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ecopay", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ecopay", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ecopay", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ecopay", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ecopay", "mnbudget", &mnbudget, true, true, false},
        {"ecopay", "preparebudget", &preparebudget, true, true, false},
        {"ecopay", "submitbudget", &submitbudget, true, true, false},
        {"ecopay", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ecopay", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ecopay", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ecopay", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ecopay", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ecopay", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ecopay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ecopay", "checkbudgets", &checkbudgets, true, true, false},
        {"ecopay", "mnsync", &mnsync, true, true, false},
        {"ecopay", "spork", &spork, true, true, false},
        {"ecopay", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"ecopay", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"ecopay", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"ecopay", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"ecopay", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"ecopay", "mncommunityvote", &mncommunityvote, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> ecopay-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17733/\n";
}
