...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("EcoPay Core ecopay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ecopay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ecopay transaction") + "\n" +
                               "  ecopay-tx [options] -create [commands]   " + _("Create hex-encoded ecopay transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ecopay transaction
