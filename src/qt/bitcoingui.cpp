                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("EcoPay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ECP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ecopay: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EcoPay Core"), this);
    aboutAction->setStatusTip(tr("Show information about EcoPay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EcoPay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ECP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ECP addresses"));
    ...
    openAction->setStatusTip(tr("Open a ecopay: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EcoPay Core help message to get a list with possible EcoPay command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EcoPay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EcoPay network", "", count));
}
...
{
    QString strTitle = tr("EcoPay Core"); // default title
