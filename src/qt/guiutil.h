...
/** Utility functions used by the EcoPay Qt UI.
 */
namespace GUIUtil
{
...
// Render ECP addresses in monospace font
...
// Parse "ecopay:" URI into recipient object, return true on successful parsing
