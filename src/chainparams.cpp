...
// Copyright (c) 2017-2018 The EcoPay developers
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // EcoPay: 1 day
        nTargetSpacing = 2 * 60;  // EcoPay: 2 minutes
        nMaturity = 10;
        ...
        nLastPOWBlock = 50;
        nModifierUpdateBlock = 1; // we use the version 2 for ECP

        /**
         * Build the genesis block. Note that the output of the genesis coinbase cannot
         * be spent as it did not originally exist in the database.
         *
         * python gen.py -a quark-hash -z "Even With Energy Surplus, Canada Unable to Meet Electricity Demands of Bitcoin Miners" -t 1516926684 -v 0 -p 04e5a8143f86ad8ac63791fbbdb8e0b91a8da88c8c693a95f6c2c13c063ea790f7960b8025a9047a7bc671d5cfe707a2dd2e13b86182e1064a0eea7bf863636363
         ...
         */
        const char* pszTimestamp = "EcoPay - next crypto step";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1536418252;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 529939;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000006e3b87a5a263fcc5d6a00d4419989bcad0b5ae4ecbbf950ce21aedd15c9"));
        assert(genesis.hashMerkleRoot == uint256("0x94938c75e304b0bc749f0ebcd7a6906c7993d1ba5dfd8883b82ae4b75d7e06fa"));

        // DNS Seeding
        vFixedSeeds.clear();
        vSeeds.clear();

        // EcoPay addresses start with 'G'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 38);
        // EcoPay script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // EcoPay private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // EcoPay BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // EcoPay BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // EcoPay BIP44 coin type is '222' (0x800000de)
        ...
        nStartMasternodePayments = genesis.nTime ; // 0 hours after genesis creation
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // EcoPay: 1 day
        nTargetSpacing = 2 * 60;  // EcoPay: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        // Testnet EcoPay addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet EcoPay script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet EcoPay BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet EcoPay BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet ecopay BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // EcoPay: 1 day
        nTargetSpacing = 2 * 60;        // EcoPay: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1536418252;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 529939;
